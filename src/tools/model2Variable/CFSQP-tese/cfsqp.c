...
/*
Return-Path: <andre@isr.umd.edu>
Received: from CMU1.ACS.CMU.EDU by GLOBE.EDRC.CMU.EDU id aa04636;
           12 Apr 97 14:05:28 EDT
Received: (from daemon@localhost) by cmu1.acs.cmu.edu (8.8.2/8.7.3) id OAA09415; Sat, 12 Apr 1997 14:05:23 -0400
Received: via localmail; Sat, 12 Apr 1997 14:05:21 -0400 (EDT)
Received: from newra.src.umd.edu (newra.src.umd.edu [128.8.111.4]) by cmu1.acs.cmu.edu (8.8.2/8.7.3) with ESMTP id OAA09411; Sat, 12 Apr 1997 14:05:18 -0400
Received: from archimedes.isr.umd.edu (archimedes.isr.umd.edu [128.8.111.95])
	by newra.src.umd.edu (8.8.5/8.8.5) with ESMTP id JAA03360
	for <cfsqp_sites@isr.umd.edu>; Sat, 12 Apr 1997 09:56:59 -0400 (EDT)
From: Andre Tits <andre@isr.umd.edu>
Received: (from andre@localhost)
	by archimedes.isr.umd.edu (8.8.5/8.8.5) id JAA03593
	for cfsqp_sites; Sat, 12 Apr 1997 09:57:00 -0400 (EDT)
Date: Sat, 12 Apr 1997 09:57:00 -0400 (EDT)
Message-Id: <199704121357.JAA03593@archimedes.isr.umd.edu>
To: cfsqp_sites@isr.umd.edu
Subject: CFSQP2.5 2/2: cfsqp.c
*/
...
struct {
	 int dlfeas,local,update,first,rhol_is1,d0_is0;
} glob_log;
...
#endif
{
   ...
   for (;;) {
	 ...
	 for (i=1; i<=nob; i++) ob[i].val=backup[i+ncnst1];
         for (i=1; i<=neqn; i++) cs[glob_info.nnineq+i].mult=psmu[i];
	 dealloc1(nparam,nrowa,a,hess,hess1,di,d,gm,
		 grdpsf,penp,bl,bu,clamda,cvec,psmu,span,backup,
		 iact,iskip,istore);
         return;
